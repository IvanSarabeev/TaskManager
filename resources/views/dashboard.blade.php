            ...
            <table class="min-w-full divide-y divide-gray-200 overflow-x-auto shadow-md">
                <thead class="text-base text-left font-semibold text-gray-900 bg-gray-50/5">
                    <tr>
                        ...
                        <th class="hidden lg:table-cell py-3.5 pl-4 pr-3">Title</th>
                        <th class="hidden lg:table-cell py-3.5 pl-4 pr-3">Description</th> 
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr>
                      ...
                      <td class="table-cell lg:max-w-sm whitespace-nowrap px-3 py-4 text-sm text-gray-500 truncate">
